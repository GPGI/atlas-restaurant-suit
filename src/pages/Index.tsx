...
import { ArrowRight, Utensils, Crown, Settings } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        ...
        <div className="space-y-4 stagger-children">
            ...
            <div className="card-premium rounded-xl p-6 hover:border-primary transition-all group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-lg font-semibold">Customer Menu</h3>
                    <p className="text-sm text-muted-foreground">Standard ordering interface</p>
                  </div>
                </div>
          ...
          {/* VIP Menu */}
          <Link to="/?table=Table_01&vip=true" className="block">
            <div className="glass-card rounded-xl p-6 hover:border-primary/50 transition-all group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-lg font-semibold">Premium Menu</h3>
                    <p className="text-sm text-muted-foreground">VIP guest experience</p>
                  </div>
                </div>
                <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" />
              </div>
